...
abundDataSets <- list(abundAll, abundPipiensAll, abundPipiensF,
                      ...
                      # abundQuinquefasciatusAll, abundQuinquefasciatusF,
                      # abundAegyptiAll, abundAegyptiF)
...
write_csv(allExt, "Data/SJV/wnv/6_interpolateData/allExt.csv")
write_csv(pipAllExt, "Data/SJV/wnv/6_interpolateData/pipiensAllExt.csv")
write_csv(pipFExt, "Data/SJV/wnv/6_interpolateData/pipiensFemaleExt.csv")
write_csv(tarAllExt, "Data/SJV/wnv/6_interpolateData/tarsalisAllExt.csv")
write_csv(tarFExt, "Data/SJV/wnv/6_interpolateData/tarsalisFemaleExt.csv")
# write_csv(quinxAllExt, "Data/SJV/wnv/6_interpolateData/quinquefasciatusAllExt.csv")
# write_csv(quinxFExt, "Data/SJV/wnv/6_interpolateData/quinquefasciatusFemaleExt.csv")
# write_csv(aegAllExt, "Data/SJV/wnv/6_interpolateData/aegyptiAllExt.csv")
# write_csv(aegFExt, "Data/SJV/wnv/6_interpolateData/aegyptiFemaleExt.csv")
